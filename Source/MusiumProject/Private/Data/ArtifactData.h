...
struct FArtifactData : public FTableRowBase
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite)  TSoftObjectPtr<UTexture2D> Description = nullptr;

    UPROPERTY(EditAnywhere, BlueprintReadWrite)  TSoftObjectPtr<UTexture2D> Thumbnail = nullptr;

    UPROPERTY(EditAnywhere, BlueprintReadWrite)  TSoftObjectPtr<UTexture2D> TechniqueDescription = nullptr;

    UPROPERTY(EditAnywhere, BlueprintReadWrite)  TSoftObjectPtr<UTexture2D> PatternMeaning = nullptr;

    UPROPERTY(EditAnywhere, BlueprintReadWrite)  TSoftObjectPtr<UTexture2D> SimularItem = nullptr;
